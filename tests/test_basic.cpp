...
namespace {
	...
	TEST_F(TextureTest, Create64x100) {
		...
		vmtest::TextureFP32 tex(64, 100, 1, [](int i, int j, int w, int h, int mip)->float {return 0.f; });
	...
	TEST_F(TextureTest, Create100x100) {
		vmtest::TextureFP32 tex(100, 100, 1, [](int i, int j, int w, int h, int mip)->float {return 0.f; });
	...
	TEST_F(TextureTest, Create100x64) {
		vmtest::TextureFP32 tex(100, 64, 1, [](int i, int j, int w, int h, int mip)->float {return 0.f; });
	...
	TEST_F(TextureTest, Create0x64) {
		vmtest::TextureFP32 tex(0, 64, 1, [](int i, int j, int w, int h, int mip)->float {return 0.f; });
	...
	TEST_F(TextureTest, Create0x0) {
		vmtest::TextureFP32 tex(0, 0, 1, [](int i, int j, int w, int h, int mip)->float {return 0.f; });
	...
	TEST_F(TextureTest, Create65536x0) {
		vmtest::TextureFP32 tex(65536, 1, 1, false /*enableZorder*/, [](int i, int j, int w, int h, int mip)->float {return 0.f; });
	...
	TEST_F(TextureTest, Create65537x0) {
		vmtest::TextureFP32 tex(65537, 1, 1, false /*enableZorder*/, [](int i, int j, int w, int h, int mip)->float {return 0.f; });
