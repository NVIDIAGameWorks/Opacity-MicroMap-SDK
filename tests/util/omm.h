...
namespace vmtest 
{
	...
	struct TextureImpl
	{
		TextureImpl(int w, int h, int mipCount, bool enableZorder, bool enableStaticAlphaCutoff, std::function<T(int x, int y, int w, int h, int mip)> cb)
		{
			...
			if (enableStaticAlphaCutoff)
				_desc.alphaCutoff = 0.5f;
